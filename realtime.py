...
class RealtimeDroneDetector:
    def __init__(self, model_path='best_drone_model.pth', 
        ...
        # Determine drone class indices (anything that's not "no_drone" or "unknown")
        self.drone_classes = []
...
class DroneDetectionVisualizer:
    ...
    def update_plot(self, frame):
        ...
        # Change title and background based on detection
...
def main():
    ...
    SECONDS_IN_VIEW = 2.0       # seconds visible on spectrogram
    NFFT = 1024                 # FFT resolution
    ANALYSIS_INTERVAL = 1.0     # analyze every N seconds
