...
import librosa
import joblib
from train import DroneNN, extract_features  # reuse same functions!
...
def predict_audio(model_path, scaler_path, class_names, audio_path):
    ...
    input_dim = len(extract_features(audio_path))  # just to infer shape
...
if __name__ == "__main__":
    ...
    # Determine class names from the dataset
